$(document).ready(function() {
  $('#map').usmap({});
  $("#state_title").show();
  $("#no_bills_info, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
});
...
(function($, document, window, Raphael, undefined) {
  ...
  var defaults = {
    ...
    'clickState': { 
      'AL': function(click, data){ //1 No bills
        $("#state_title").text("The State of Alabama");
        $("#no_bills_info").show();
        $("#map_instruction, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'AK': function(click, data){ // 2
        $("#state_title").text("The State of Alaska");
        $("#AK_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'AZ': function(click, data){ // 3
        $("#state_title").text("The State of Arizona");
        $("#AZ_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'AR': function(click, data){ //4 No bills
        $("#state_title").text("The State of Arkansas");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'CA': function(click, data){ //5
        $("#state_title").text("The State of California");
        $("#CA_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'CO': function(click, data){ // 6
        $("#state_title").text("The State of Colorado");
        $("#CO_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'CT': function(click, data){ // 7
        $("#state_title").text("The State of Connecticut");
        $("#CT_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'DE': function(click, data){ //8 No bills
        $("#state_title").text("The State of Delaware");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'FL': function(click, data){ // 9
        $("#state_title").text("The State of Florida");
        $("#FL_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'GA': function(click, data){ // 10
        $("#state_title").text("The State of Georgia");
        $("#GA_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'HI': function(click, data){ //11
        $("#state_title").text("The State of Hawaii");
        $("#HI_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'ID': function(click, data){ //12 No bills
        $("#state_title").text("The State of Idaho");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'IL': function(click, data){ //13 No bills
        $("#state_title").text("The State of Illinois");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'IN': function(click, data){ // 14
        $("#state_title").text("The State of Indiana");
        $("#IN_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'IA': function(click, data){ // 15
        $("#state_title").text("The State of Iowa");
        $("#IA_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'KS': function(click, data){ //16 No bills
        $("#state_title").text("The State of Kansas");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'KY': function(click, data){ // 17
        $("#state_title").text("The State of Kentucky");
        $("#KY_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'LA': function(click, data){ //18
        $("#state_title").text("The State of Louisiana");
        $("#LA_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'ME': function(click, data){ // 19
        $("#state_title").text("The State of Maine");
        $("#ME_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'MD': function(click, data){ // 20
        $("#state_title").text("The State of Maryland");
        $("#MD_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'MA': function(click, data){ // 21
        $("#state_title").text("The State of Massachusetts");
        $("#MA_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'MI': function(click, data){ //22 No bills
        $("#state_title").text("The State of Michigan");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'MN': function(click, data){ // 23
        $("#state_title").text("The State of Minnesota");
        $("#MN_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'MS': function(click, data){ // 24
        $("#state_title").text("The State of Mississippi");
        $("#MS_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'MO': function(click, data){ //25 No bills
        $("#state_title").text("The State of Missouri");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'MT':function(click, data){ //26 No bills
        $("#state_title").text("The State of Montana");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'NE': function(click, data){ // 27
        $("#state_title").text("The State of Nebraska");
        $("#NE_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'NV': function(click, data){ //28 No bills
        $("#state_title").text("The State of Nevada");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'NH': function(click, data){ //29 No bills
        $("#state_title").text("The State of New Hampshire");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'NJ': function(click, data){ // 30
        $("#state_title").text("The State of New Jersey");
        $("#NJ_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'NM': function(click, data){ //31 No bills
        $("#state_title").text("The State of New Mexico");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'NY': function(click, data){ // 32
        $("#state_title").text("The State of New York");
        $("#NY_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'NC': function(click, data){ // 33
        $("#state_title").text("The State of North Carolina");
        $("#NC_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'ND': function(click, data){ //34 No bills
        $("#state_title").text("The State of North Dakota");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'OH': function(click, data){ // 35
        $("#state_title").text("The State of Ohio");
        $("#OH_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'OK': function(click, data){ // 36
        $("#state_title").text("The State of Oklahoma");
        $("#OK_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'OR': function(click, data){ //37 No bills
        $("#state_title").text("The State of Oregon");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'PA': function(click, data){ // 38
        $("#state_title").text("The State of Pennsylvania");
        $("#PA_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'RI': function(click, data){ // 39
        $("#state_title").text("The State of Rhode Island");
        $("#RI_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'SC': function(click, data){ //40 No bills
        $("#state_title").text("The State of South Carolina");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'SD': function(click, data){ //41 No bills
        $("#state_title").text("The State of South Dakota");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'TN': function(click, data){ //42 No bills
        $("#state_title").text("The State of Tennessee");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'TX': function(click, data){ //43 No bills
        $("#state_title").text("The State of Texas");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'UT': function(click, data){ // 44
        $("#state_title").text("The State of Utah");
        $("#UT_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'VT': function(click, data){ // 45
        $("#state_title").text("The State of Vermont");
        $("#VT_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'VA': function(click, data){ // 46
        $("#state_title").text("The State of Virginia");
        $("#VA_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #WA_info, #WV_info, #WI_info").hide();
      },
      'WA': function(click, data){ // 47
        $("#state_title").text("The State of Washington");
        $("#WA_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WV_info, #WI_info").hide();
      },
      'WV': function(click, data){ // 48
        $("#state_title").text("The State of West Virginia");
        $("#WV_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WI_info").hide();
      },
      'WI': function(click, data){ // 50
        $("#state_title").text("The State of Wisconsin");
        $("#WI_info, #back_to_top").show();
        $("#map_instruction, #no_bills_info, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info").hide();
      },
      'WY': function(click, data){ //50 No bills
        $("#state_title").text("The State of Wyoming");
        $("#no_bills_info").show();
        $("#map_instruction, #back_to_top, #AK_info, #AZ_info, #CA_info, #CO_info, #CT_info, #FL_info, #GA_info, #HI_info, #IN_info, #IA_info, #KY_info, #LA_info, #ME_info, #MD_info, #MA_info, #MN_info, #MS_info, #NE_info, #NJ_info, #NY_info, #NC_info, #OH_info, #OK_info, #PA_info, #RI_info, #UT_info, #VT_info, #VA_info, #WA_info, #WV_info, #WI_info").hide();
      }
    },
